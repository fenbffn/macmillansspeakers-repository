...
class TW_Recent_Posts extends WP_Widget {
	...
	function __construct() {
		...
		$this->WP_Widget ( 'tw-recent-posts', __ ( 'TW Recent Clients ', $this->localizationDomain ), $widget_ops );
	}
...
<?php
$wp_query = new WP_Query( array('cat' => $category, 'posts_per_page' => $count, 'orderby' => $orderby, 'order' => $order, 'nopagging' => true, 'post_type' => 'client'));
...
<a href="./clients" class="see_more"><?php echo $moretext;?></a></div>
</div>
<?php
		echo $after_widget; ?>
