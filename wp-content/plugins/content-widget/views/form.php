...
<p>
    ...
    <input type="text" class="large-text" id="<?php echo $this->get_field_id('custom_title'); ?>" name="<?php echo $this->get_field_name('custom_title'); ?>" value="<?php echo $instance['custom_title'] ?>" />
</p>
...
<p>
    <label for="<?php echo $this->get_field_id('content'); ?>"><?php _e('Custom Content:'); ?></label>
    <textarea rows="10" cols="36" class="text" id="<?php echo $this->get_field_id('content'); ?>" name="<?php echo $this->get_field_name('content'); ?>"><?php echo $instance['content'] ?></textarea>
</p>
...
<p>
    <input id="<?php echo $this->get_field_id('hidecontent'); ?>" name="<?php echo $this->get_field_name('hidecontent'); ?>" type="checkbox" <?php checked( $instance['hidecontent'], 1 ); ?> value="1" />&nbsp;<label for="<?php echo $this->get_field_id('hidecontent'); ?>"><?php _e('Hide Content?'); ?></label>
</p>