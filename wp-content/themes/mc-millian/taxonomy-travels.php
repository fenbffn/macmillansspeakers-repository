    ...
    <section class="group-content">
        <div class="pagination">
            ...
            <p>
                ...
                <a href="<?php echo esc_url( home_url( '/' ) ); ?>travels/<?php echo $term->slug; ?>/?page=<?php echo $page ?>"><img src="<?php echo esc_url( home_url( '/' ) ); ?>wp-content/uploads/2013/02/next.png" alt=""></a>
            </p>
            <?php } else {?>
            <?php $cant_post =  $wp_query->post_count;?>
            <p><a href="<?php echo esc_url( home_url( '/' ) ); ?>travels/<?php echo $term->slug; ?>/?page=<?php echo $page-2 ?>"><img src="<?php echo esc_url( home_url( '/' ) ); ?>wp-content/uploads/2013/02/before.png" alt="" /></a>
