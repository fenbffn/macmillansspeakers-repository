<?php
function mcmillian_options()
{
    $themename = "Mc-Millian";
    $shortname = "mcmillian";
    ...
    update_option('mcmillian_template', $options);
    update_option('mcmillian_themename', $themename);
    update_option('mcmillian_shortname', $shortname);

}

add_action('init', 'mcmillian_options');

function mytheme_add_admin()
{

    $options = get_option('mcmillian_template');
    $themename = get_option('mcmillian_themename');
    $shortname = get_option('mcmillian_shortname');
...
<h2><b><?php echo $themename; ?> theme options</b></h2>
        ...
        <table class="optiontable">
            ...
            if ($value['type'] == "text") {
                ...
                <tr align="left">
                    ...
                    <td>
                        <input name="<?php echo $value['id']; ?>" id="<?php echo $value['id']; ?>"
                               type="<?php echo $value['type']; ?>" value="<?php if (get_settings($value['id']) != "") {
                ...
                <tr align="left">
                    <th scope="row"><?php echo $value['name']; ?>:</th>
                    <td>
                        <textarea name="<?php echo $value['id']; ?>" id="<?php echo $value['id']; ?>" cols="50"
                                  rows="8"/>
                ...
                <tr valign="top">
                    <td colspan="2" style="text-align: left;"><h2
                            style="color:green;"><?php echo $value['name']; ?></h2></td>
                </tr>
                <tr>
                    <td colspan=2>
                        <small><p style="color:red; margin:0 0;"> <?php echo $value['desc']; ?> </P></small>
                        <hr/>
                    </td>
                </tr>
    ...
    <p> For more <a href="http://web2feel.com">wordpress themes </a>and support, contact the <a
            href="http://web2feel.com/forum/"> support forums </a></p>
    <?php
}
